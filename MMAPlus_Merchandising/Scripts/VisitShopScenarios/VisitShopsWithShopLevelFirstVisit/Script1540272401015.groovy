...
Mobile.tap(findTestObject('DashboardScreenElements/StartYourDay'), 0)

Mobile.verifyElementText(findTestObject('Validate_ShopListScreen'), 'Shops on Route')

CustomKeywords.'com.ct.qa.keywords.ShopVisitingScenariosKeywords.visitShopsWithShopLevel_FirstVisit'()
