...
MobileBuiltInKeywords.verifyElementText(findTestObject('DistributionPoint/Validate_DistributionPointScreen' , [('package') : ProjectConstants.PACKAGENAME]), 'Poster Quantity:')
