...
MobileBuiltInKeywords.tap(findTestObject('ShopOpen/ChillerUtilization/ChillerNotAvailable/Planogram_ImageView' , [('package') : ProjectConstants.PACKAGENAME]), 0)
...
'tap on back button'
MobileBuiltInKeywords.tap(findTestObject('ShopOpen/ChillerUtilization/ChillerNotAvailable/ChillerNotAvailable_BackButton' , [('package') : ProjectConstants.PACKAGENAME]), 
    0)
