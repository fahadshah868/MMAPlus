...
CustomKeywords.'com.ct.qa.keywords.ChillerVisitingScenariosKeywords.findChillerRemark'('Chiller Type not Available')

WebUI.callTestCase(findTestCase('ShopOpen/ChillerUtilization/ChillerTypeNotAvailable/VisitChillerTypeNotAvailable'), [:], 
