...
CustomKeywords.'com.ct.qa.keywords.ChillerVisitingScenariosKeywords.findChillerRemark'('Chiller removed for maintenance')

WebUI.callTestCase(findTestCase('ShopOpen/ChillerUtilization/ChillerRemovedForMaintenance/VisitChillerRemovedForMaintenance'), 
