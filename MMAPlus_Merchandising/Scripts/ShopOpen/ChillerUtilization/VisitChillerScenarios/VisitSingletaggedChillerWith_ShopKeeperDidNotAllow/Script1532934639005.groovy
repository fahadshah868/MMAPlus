...
CustomKeywords.'com.ct.qa.keywords.ChillerVisitingScenariosKeywords.findChillerRemark'('Shopkeeper did not allow')

WebUI.callTestCase(findTestCase('ShopOpen/ChillerUtilization/ShopKeeperDidNotAllow/VisitShopKeeperDidNotAllow'), [:], FailureHandling.STOP_ON_FAILURE)
