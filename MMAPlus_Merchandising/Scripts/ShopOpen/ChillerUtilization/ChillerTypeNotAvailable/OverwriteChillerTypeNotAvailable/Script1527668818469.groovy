...
MobileBuiltInKeywords.tap(findTestObject('ShopOpen/ChillerUtilization/ChillerTypeNotAvailable/ChillerType'), 
    0)
...
Mobile.callTestCase(findTestCase('ShopOpen/ChillerUtilization/ChillerTypeNotAvailable/OverwriteChillerType'), [:], FailureHandling.STOP_ON_FAILURE)
