...
CustomKeywords.'com.ct.qa.keywords.ChillerKeywords.visitChillerAvailableProductCategories'(1)
...
Mobile.tap(findTestObject('ShopOpen/ChillerUtilization/ChillerRemarks_BackButton'), 0)
