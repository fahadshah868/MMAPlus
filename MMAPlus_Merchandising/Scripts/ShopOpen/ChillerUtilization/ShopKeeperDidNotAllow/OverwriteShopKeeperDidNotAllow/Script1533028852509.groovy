...
MobileBuiltInKeywords.tap(findTestObject('ShopOpen/ChillerUtilization/ShopKeeperDidNotAllow/CategoryRemarks_Others' , [('package') : ProjectConstants.PACKAGENAME]), 0)
