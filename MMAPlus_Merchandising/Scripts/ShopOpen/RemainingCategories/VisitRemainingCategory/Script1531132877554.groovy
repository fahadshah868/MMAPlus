...
not_run: CustomKeywords.'com.ct.qa.keywords.KeywordsCollection.findShopProduct'('Sachets')

not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/NoSpaceForDisplay'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('null'), 'Category:Sachets')

not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/Facing'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('ShopOpen/RemainingCategories/Validate_FacingScreen'), 'Facing')

not_run: CustomKeywords.'com.ct.qa.keywords.KeywordsCollection.visitSachetsProducts'()

not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/SubmitButton'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('null'), 'Category:Sachets')

not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/StockTaking'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('ShopOpen/RemainingCategories/Validate_StockTakingScreen'), 
    'Stock Taking')
...
not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/planogram_ImageView'), 0)

not_run: CustomKeywords.'com.ct.qa.keywords.KeywordsCollection.checkPlanogramAvailability'()

not_run: MobileBuiltInKeywords.tap(findTestObject('null'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('null'), 'Category:Sachets')

not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/Picture_ImageView'), 0)

not_run: MobileBuiltInKeywords.verifyElementExist(findTestObject('CommonScreenElements/Validate_CameraScreen'), 0)

not_run: MobileBuiltInKeywords.tap(findTestObject('CommonScreenElements/TakePictureButton'), 0)

not_run: MobileBuiltInKeywords.tap(findTestObject('CommonScreenElements/DoneButton'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('null'), 'Category:Sachets')

not_run: MobileBuiltInKeywords.tap(findTestObject('ShopOpen/RemainingCategories/ProductCategoryAsset_BackButton'), 0)

not_run: MobileBuiltInKeywords.verifyElementText(findTestObject('ShopOpen/ShopChannel'), 'Channel: Small Kiryana')
