...
CustomKeywords.'qa.keywords.ChannelProductsDataKeywords.visitChannelWiseProductsData'(ProjectConstants.CHANNEL_NSFD_FACING, 
    'Facing')
...
CustomKeywords.'qa.keywords.ChannelProductsDataKeywords.visitChannelWiseProductsData'(ProjectConstants.CHANNEL_NSFD_STOCKTAKING, 
    'Stock Taking')
