...
CustomKeywords.'qa.keywords.ChannelProductsDataKeywords.visitChannelWiseProductsData'(ProjectConstants.CHANNEL_DSA_FACING, 
    'Facing')
...
CustomKeywords.'qa.keywords.ChannelProductsDataKeywords.visitChannelWiseProductsData'(ProjectConstants.CHANNEL_DSA_STOCKTAKING, 
    'Stock Taking')
